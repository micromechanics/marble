...
import unittest
from pymarble.backend import BinaryFile
from pymarble.backend.section import Section
...
class TestStringMethods(unittest.TestCase):
  def test_main(self):
    ...
    try:
      ...
      self.assertTrue(str(fBIN.content[69280])=='58076|d|||||44|58076|90|-1.0000|False|exportedData_col=1','1st start wrong')
      print(fBIN.content[533888])
      self.assertTrue(str(fBIN.content[533888])=='58076|f|||||44|58076|76|-1.0000|False|exportedData_col=2','2nd start wrong')
      print(fBIN.content[766192])
      self.assertTrue(str(fBIN.content[766192])=='58076|f|||||44|58076|90|-1.0000|False|exportedData_col=3','3rd start wrong')
