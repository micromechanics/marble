...
"${PYTHON:-.venv/bin/python}" tests/examples/Membrane_Repeatability_05.py tests/examples/Membrane_Repeatability_05.mvl
"${PYTHON:-.venv/bin/python}" tests/examples/Membrane_Repeatability_05.py tests/examples/Membrane_Repeatability_08.mvl
